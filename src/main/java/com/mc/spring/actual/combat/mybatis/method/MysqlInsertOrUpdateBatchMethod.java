 ...
 */
public class MysqlInsertOrUpdateBatchMethod extends AbstractMethod {
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        return this.addInsertMappedStatement(mapperClass, modelClass, "mysqlInsertOrUpdateBatch", sqlSource, new NoKeyGenerator(), null, null);
